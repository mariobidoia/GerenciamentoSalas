      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        let currentSectorFilter = "all"; // 'all' por padrão
        ...
        function getConfirmedBookingForDate(roomId, date, periodId) {
          // (Função getConfirmedBookingForDate mantida)
        ...
        // NOVO: Função para atualizar o subtítulo
        function updateReportTitle() {
          if (!reportSubtitle || !sectorFilter) return;
          const selectedText =
            sectorFilter.options[sectorFilter.selectedIndex].text;
          // Remove o ícone (emoji) do texto para uma exibição mais limpa
        ...
        async function loadReportData() {
          ...
          calendarGrid.style.display = "none";
          if (monthYearDisplay)
            monthYearDisplay.textContent = "Carregando Dados...";
        ...
        function renderCalendar(year, month) {
          ...
          // NOVO: Atualiza Subtítulo do Setor
          updateReportTitle();
          ...
          weekdays.forEach((day) => {
            html += `<div class="font-semibold p-2 weekday-header text-sm">${day}</div>`;
          });
          ...
          for (let day = 1; day <= daysInMonth; day++) {
            ...
            // --- LÓGICA DE FILTRAGEM E RENDERIZAÇÃO (Modificada) ---
            ...
            // Renderiza a lista plana (sem cabeçalho de setor)
        ...
        if (sectorFilter) {
          sectorFilter.onchange = () => {
            ...
            // Apenas re-renderiza, a renderCalendar vai atualizar o título
            renderCalendar(
              currentMonthDate.getUTCFullYear(),
              currentMonthDate.getUTCMonth()
            );
